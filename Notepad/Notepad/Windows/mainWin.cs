...
namespace Notepad
{
    public partial class mainWin : Form
    {
        ...
        {
            NotepadCore.Font(richTextBox1, timesNewRomanToolStripMenuItem.Text);
        }
        private void segoeUIToolStripMenuItem_Click(object sender, EventArgs e)
        {
            NotepadCore.Font(richTextBox1, segoeUIToolStripMenuItem.Text);
        }
        private void consolasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            NotepadCore.Font(richTextBox1, consolasToolStripMenuItem.Text);
        }
        private void cambriaMathToolStripMenuItem_Click(object sender, EventArgs e)
        {
            NotepadCore.Font(richTextBox1, cambriaMathToolStripMenuItem.Text);
        }
    }
}
